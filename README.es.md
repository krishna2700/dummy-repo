...
## ¿Qué es React?
React es una biblioteca de JavaScript creada para construir interfaces de usuario (UI) de manera **modular**, **rápida** y **mantenible**. Se utiliza principalmente para desarrollar aplicaciones web modernas basadas en componentes.
...
- **Buena mantenibilidad**: arquitectura clara para aplicaciones en crecimiento.

## Conceptos clave

### 1) Los componentes
Un componente es una función (o clase) que retorna una interfaz.
